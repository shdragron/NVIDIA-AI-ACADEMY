...
def yolov1_main():
    ...
    model.compile(loss=yolo_loss, optimizer=optimizer) # 별도의 로스 함수
    ...
    datasets_path = 'C:/Users/Harmony05/Desktop/NVIDIA-AI-ACADEMY/Data_set/1_yolov1-keras-voc_annotation/yolov1-keras-voc_annotation/VOCdevkit/'  # dataset 존재하는 경로 위치
