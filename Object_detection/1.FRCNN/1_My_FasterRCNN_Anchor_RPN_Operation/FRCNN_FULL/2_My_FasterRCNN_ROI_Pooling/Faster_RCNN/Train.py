...
class TrainCls():
    def __init__(self, NumberOfanchorboxes,  # 9
        ...
        self.rpn_model_dir = './Trained_Models/my_rpn_model.h5' # rpn모델 저장 경로
        self.rcnn_model_dir = './Trained_Models/my_rcnn_model.h5' # rcnn모델 저장 경로
    ...
    def Train_start(self):
        ...
        # 256 roi_boxes_batch 활용 RCNN Detector 타깃 생성
